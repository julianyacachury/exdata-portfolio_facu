...
type TranslationKeys = {
  ...
  "projects.OCR.title": string
  "projects.OCR.category": string
  "projects.OCR.description": string
  "projects.OCR.challenge": string
  "projects.OCR.solution": string
  "projects.OCR.results": string
  "projects.ExactasAgent.title": string
  "projects.ExactasAgent.category": string
  "projects.ExactasAgent.description": string
  "projects.ExactasAgent.challenge": string
  "projects.ExactasAgent.solution": string
  "projects.ExactasAgent.results": string
  "projects.DIBtoDCOM.title": string
  "projects.DIBtoDCOM.category": string
  "projects.DIBtoDCOM.description": string
  "projects.DIBtoDCOM.challenge": string
  "projects.DIBtoDCOM.solution": string
  "projects.DIBtoDCOM.results": string
...
const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    "tech.cpp.description": "Powerful language for systems programming and high-performance applications",
    "tech.rust.description": "Memory-safe and concurrent systems programming language",
  ...
  es: {
    ...
    "tech.cpp.description": "Lenguaje potente para programación de sistemas y aplicaciones de alto rendimiento",
    "tech.rust.description": "Lenguaje de programación de sistemas seguro en memoria y concurrente",
